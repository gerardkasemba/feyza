      ...
      <div className="min-h-screen flex flex-col bg-neutral-50">
        ...
        <main className="flex-1 flex items-center justify-center p-4">
          <Card className="max-w-md w-full text-center">
            ...
            <h1 className="text-xl font-bold text-neutral-900 mb-2">Request Not Found</h1>
            <p className="text-neutral-600 mb-6">{error || 'This loan request may have been removed or expired.'}</p>
            <Link href="/">
      ...
      <main className="flex-1 py-12 px-4">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex justify-center mb-6">
            <Badge variant={request.status === 'pending' ? 'warning' : 'success'} className="text-sm px-4 py-2">
          ...
          <Card className="mb-6">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-neutral-500 mb-2">Loan Request</p>
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-center gap-3 p-4 bg-neutral-50 rounded-xl">
                ...
                <div>
                  <p className="text-sm text-neutral-500">Borrower</p>
                  <p className="font-medium text-neutral-900">{request.borrower_name}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-4 bg-neutral-50 rounded-xl">
                ...
                <div>
                  <p className="text-sm text-neutral-500">Requested On</p>
                  <p className="font-medium text-neutral-900">{formatDate(request.created_at)}</p>
                </div>
              </div>
            </div>
              ...
              <div className="border-t border-neutral-200 pt-6">
                ...
                <div className="flex gap-2 mb-4">
                  <input
                    ...
                    value={shareUrl}
                    readOnly
                    className="flex-1 px-4 py-2 bg-neutral-50 border border-neutral-200 rounded-lg text-sm"
                  />
